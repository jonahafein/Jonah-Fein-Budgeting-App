...
if st.session_state.email:
    ...
    months_emergency_desire = st.slider("Ideally, how many months of expenses would you consider to be suffient savings for your emergency fund? (3-6 months is most common)", value = st.session_state.months_emergency_desire, max_value = 36)
